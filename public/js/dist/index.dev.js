...
function addPost() {
  var currentDate, formData, likeCount, comments, i, response, newPost, errorResponse;
      ...
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          articles.forEach(function (article) {
            ...
            mainFeedList.addEventListener('click', function (event) {
              var postCommentBtn = event.target.closest('.post-comment-btn');

              if (postCommentBtn) {
                var _postId2 = postCommentBtn.getAttribute('data-post-id');

                var userId = loggedInUserId;
                console.log('Post comment button is activated for postId:', _postId2, 'by userId', userId);
                ...
                localStorage.setItem('postId', _postId2);
                window.location.href = "/comments/render/".concat(_postId2, "/").concat(userId); // window.location.href = `/comments/render/${encodeURIComponent(postId)}/${encodeURIComponent(userId)}`;
              }
            });
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 8:
          ...
          newCount = isLiked ? currentCount - 1 : currentCount + 1; // Toggle Button State when click
        ...
        case 22:
          ...
          updateLikeCount(postId, updatedPost.likeCount); // Toggle Button State when render
