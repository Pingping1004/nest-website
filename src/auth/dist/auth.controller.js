...
var AuthController = /** @class */ (function () {
    function AuthController(authservice, postService) {
    ...
    AuthController.prototype.renderAuthIndex = function (id, req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userIdFromParam, userId, role, posts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        res.render('index', { userId: userId, role: role, posts: posts });
                        return [2 /*return*/];
                }
            });
        });
    ...
    AuthController.prototype.renderAdminAuthIndex = function (id, req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userIdFromParam, user, userId, role;
            return __generator(this, function (_a) {
                userIdFromParam = parseInt(id, 10);
                // Check if parsing was successful
                if (isNaN(userIdFromParam)) {
                ...
                res.render('admin', { userId: userId, role: role, user: user });
                return [2 /*return*/];
            });
        });
    };
