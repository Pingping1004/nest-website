...
var AuthService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        payload = { username: foundUser.username, userId: foundUser.userId, role: foundUser.role, profilePicture: foundUser.profilePicture };
    ...
    AuthService.prototype.googleLogin = function (req) {
        return __awaiter(this, void 0, Promise, function () {
            var _a, username, email, role, profilePicture, googleId, user, payload;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!req.user) {
                        ...
                        _a = req.user, username = _a.username, email = _a.email, role = _a.role, profilePicture = _a.profilePicture, googleId = _a.googleId;
                        return [4 /*yield*/, this.userService.findByGoogleId(googleId)];
                    case 1:
                        user = _b.sent();
                    ...
                    case 2:
                        ...
                        _b.label = 3;
                    case 3:
                        payload = { username: user.username, userId: user.userId, role: user.role };
                        return [2 /*return*/, {
                                accessToken: this.jwtService.sign(payload),
                                user: user
                            }];
