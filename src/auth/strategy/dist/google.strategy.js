...
var GoogleStrategy = /** @class */ (function (_super) {
    ...
    function GoogleStrategy(authService, userService) {
    ...
    GoogleStrategy.prototype.validate = function (accessToken, refreshToken, profile, done) {
        return __awaiter(this, void 0, Promise, function () {
            var id, emails, photos, _a, givenName, familyName, user;
            return __generator(this, function (_b) {
                id = profile.id, emails = profile.emails, photos = profile.photos;
                _a = profile.name || {}, givenName = _a.givenName, familyName = _a.familyName;
                user = {
                    googleId: id,
