...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.findByGoogleId = function (googleId) {
        return __awaiter(this, void 0, Promise, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.findOne({ where: { googleId: googleId } })];
                    case 1:
                        user = _a.sent();
                        if (!user) {
                            console.log("No user found with googleId: " + googleId);
                        }
                        return [2 /*return*/, user]; // Returns null if no user is found
                }
            });
        });
    };
    ...
    UsersService.prototype.updateProfile = function (userId, updatedUserDto, profilePictureUrl) {
        return __awaiter(this, void 0, Promise, function () {
            var user, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        throw new common_1.InternalServerErrorException('Could not update profile');
                    case 4: return [2 /*return*/];
                }
            });
        });
