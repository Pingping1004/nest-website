...
var AdminController = /** @class */ (function () {
    function AdminController(usersService) {
    ...
    AdminController.prototype.updateUser = function (userId, updatedUserDto, req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var adminName, updatedUser, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        adminName = req.user.name;
                        return [4 /*yield*/, this.usersService.updateUser(userId, adminName, updatedUserDto)];
                    case 1:
                        updatedUser = _a.sent();
                        if (!updatedUser) {
    ...
    AdminController.prototype.deleteUser = function (userId, req, res) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var adminName, deletedUser, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        adminName = (_a = req.user) === null || _a === void 0 ? void 0 : _a.name;
